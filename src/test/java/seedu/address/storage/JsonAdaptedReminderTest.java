...
public class JsonAdaptedReminderTest {
    ...
    public void toModelType_invalidDueDate_throwsIllegalValueException() {
        JsonAdaptedReminder reminder =
                new JsonAdaptedReminder(INVALID_DUEDATE, VALID_DESCRIPTION);
    ...
    public void toModelType_nullDueDate_throwsIllegalValueException() {
        JsonAdaptedReminder reminder = new JsonAdaptedReminder(null, VALID_DESCRIPTION);
    ...
    public void toModelType_invalidDescription_throwsIllegalValueException() {
        JsonAdaptedReminder reminder =
                new JsonAdaptedReminder(VALID_DUEDATE, INVALID_DESCRIPTION);
    ...
    public void toModelType_nullDescription_throwsIllegalValueException() {
        JsonAdaptedReminder reminder = new JsonAdaptedReminder(VALID_DUEDATE, null);
