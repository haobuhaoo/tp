...
/** Parses input for {@link GroupRemoveCommand}. */
    ...
    public GroupRemoveCommand parse(String args) throws ParseException {
        ...
        if (!arePresent(map, PREFIX_GROUP, PREFIX_INDEX)
            ...
            throw new ParseException(String.format(
                    Messages.MESSAGE_INVALID_COMMAND_FORMAT, GroupRemoveCommand.MESSAGE_USAGE));
        }
        ...
        return new GroupRemoveCommand(groupName, indices);
    }
