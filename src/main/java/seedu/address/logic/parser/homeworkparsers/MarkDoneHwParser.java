...
/**
 * Parses input arguments and creates a new {@code MarkDoneHwCommand} object.
 * <p>
 ...
 */
public class MarkDoneHwParser {
    /**
     * Parses the given {@code String} of arguments in the context of the {@code MarkDoneHwCommand}
     * and returns an MarkDoneHw object for execution.
     *
     * @param args Full user input string containing the command arguments.
     * @return An {@code MarkDoneHwCommand} object that is ready to be executed.
